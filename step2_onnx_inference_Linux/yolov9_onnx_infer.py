...
def detect(img_path):
    ...
    # print(image.shape)
    print("The onnx model used is from", ONNX_Model_path)
    ort_session = ort.InferenceSession(ONNX_Model_path,providers=['AzureExecutionProvider', 'CPUExecutionProvider'])
    ...
    print("Image Result saved to", output_image_path)
